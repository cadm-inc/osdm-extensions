...
The `HoleWizard` extension module is shipped in a single ZIP
...
* Open the _Load_ dialog by clicking on `File --> Open...` or pressing the
  ...
  File type_ options. Browse to the 'HoleWizard' directory in the
...
".../HoleWizard/startup.lsp". `...` represents the module's install
...
".../HoleWizard/startup.lsp" file to load one of the remaining
