# Extension Module Installation and Startup {.title}{: .title}
...
The `soco_router` extension module is shipped in a single ZIP
...
* Open the _Load_ dialog by clicking on `File --> Open...` or pressing the
  ...
  File type_ options. Browse to the 'soco_router' directory in the
...
>
> ~~~ lisp
> ; Show information about the `soco_router` extension module
> (rcr:about-module)
>
> ; Show help information
> (rcr:display-module-help)
> ~~~
...
".../soco_router/startup.lsp". `...` represents the module's install
...
".../soco_router/startup.lsp" file to load one of the remaining
